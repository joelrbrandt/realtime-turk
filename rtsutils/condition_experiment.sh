...
EXPERIMENT_NUMBER=71  # what we put in the DB as the experiment number
HITS_PER_ITERATION=10
BUCKETS_IN_SECONDS=(600) #(30 60 120 300 600 1800)
BUCKET_PRICES_IN_CENTS=(12) #(2 3 4 7 12 32)
MAX_HIT_EXPIRATION_IN_MINUTES=10
DELAY_BETWEEN_POSTS_IN_MINUTES=1
ITERATIONS_PER_EXPERIMENT=240
EXPERIMENT_LENGTH_IN_MINUTES=260  # posting + waiting
...
function experiment {
    ...
    do
        ...
        python word_clicker_poster.py -c -e $1 -n $2 -b $3 -p $4 -x $expiration_time_in_seconds
        sleep $waittime
    done
