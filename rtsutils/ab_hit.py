...
TITLE = "Your Opinion Needed"
DESCRIPTION = "Have a few options and need your opinion for which is better."
KEYWORDS = "quick vote"
REWARD = 0.03

class ABHit(ExternalHit):
    def __init__(self,
                 waitbucket=120,
                 title = TITLE,
        ...
        url = "http://" + str(settings.HIT_SERVER) + "/" + str(settings.HIT_SERVER_USER_DIR) + "/ab.mpy?waittime=" + str(waitbucket)
