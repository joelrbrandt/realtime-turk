...
EXPERIMENT_NUMBER=52  # what we put in the DB as the experiment number
HITS_PER_ITERATION=10
BUCKETS_IN_SECONDS=(60 600 300 30 1800 120) #(30 60 120 300 600 1800)
BUCKET_PRICES_IN_CENTS=(3 12 7 2 32 4) #(2 3 4 7 12 32)
