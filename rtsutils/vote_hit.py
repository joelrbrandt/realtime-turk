...
TITLE = "Vote for the best photo"
DESCRIPTION = "Choose the best photo out of three"
KEYWORDS = "photography quick vote"
REWARD = 0.03

class VoteHit(ExternalHit):
    def __init__(self,
                 waitbucket=120,
                 title = TITLE,
        ...
        url = "http://" + str(settings.HIT_SERVER) + "/" + str(settings.HIT_SERVER_USER_DIR) + "/vote.mpy?waittime=" + str(waitbucket)
