...
def approve_puppeteer_hits_and_clean_up(verbose=True, dry_run=False):
    conn = mt_connection.get_mt_conn()
    print "== REVIEWING PUPPETEER HITS =="
...
if __name__ == "__main__":
    approve_puppeteer_hits_and_clean_up(verbose=True, dry_run=False)
